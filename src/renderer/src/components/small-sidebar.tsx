...
import { SettingsOutlined, Settings, Archive, ArchiveOutlined } from "@mui/icons-material";
...
export default function SmallSideBar({ activeNav, setActiveNav }: Props) {
    ...
    return (
        <div className={`md:flex md:relative z-50 hidden flex-col items-start justify-between md:h-full md:max-h-full md:min-h-full overflow-y-hidden p-2 dark:bg-[#1d1f1f] bg-[#f7f5f3]`}>
            <div className="flex flex-col gap-y-3">
                    ...
                    >
                        ...
                        >
                            {activeNav === 'chats' ? (
                                ...
                                <svg className="text-[#636261] dark:text-[#A5A5A5]" width="22" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                >
                    ...
                    >
                        {activeNav === 'archive' ? (
                            <Archive fontSize="medium" sx={(theme) => ({ color: theme.palette.mode === "dark" ? "#ffffff" : "#000000" })} />
                        ) : (
                            <ArchiveOutlined
                                fontSize="medium"
                                sx={(theme) => ({
            ...
            <div className="flex flex-col gap-y-3">
                ...
                >
                    ...
                    >
                        {activeNav === 'settings' ? (
                            <Settings fontSize="medium" sx={(theme) => ({ color: theme.palette.mode === "dark" ? "#ffffff" : "#000000" })} />
                        ) : (
                            <SettingsOutlined
                                fontSize="medium"
                                sx={(theme) => ({
