                ...
                {!isGroup && (
                    ...
                    >
                        {chatId !== selectedChatId && (
                            <button
                                onClick={handleMessageContactPrivatly}
                                className='flex flex-col items-center justify-center space-y-2 text-sm font-semibold cursor-pointer group'
                            >
                                ...
                                <Typography sx={{ color: (theme) => theme.palette.mode === 'dark' ? '#ffffff' : '#000000' }} variant='body2'>
                        ...
                        {canAddSingleContact && (
                            <button
                                onClick={handleAddUserAsContact}
                                className='flex flex-col items-center justify-center space-y-2 text-sm font-semibold cursor-pointer group'
                            >
                                <div className='flex justify-center items-center px-4 py-2 rounded-full bg-[#efecea] dark:bg-[#2c2e2e] group-hover:bg-[#e0dbd8] dark:group-hover:bg-[#3a3d3d] transition-colors duration-200'>
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
